...
<body>
  <div class="main">
    <h3 class="title-auth">Adicionar contestação</h3>
  <form class="form-add">
  ...
  <a href="/projetos/projeto_contestacoes/" class="btn btn-primary"><i class="fas fa-arrow-left icon"></i>Voltar</a>
  <button type="submit" class="btn btn-success"><i class="far fa-save icon"></i>Salvar</button>
</form>
  </div>
</body>
</html>